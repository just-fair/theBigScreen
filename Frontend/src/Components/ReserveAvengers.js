...
const ReserveAvengers = () => {
    ...
    const [editmodeavengers, seteditmodeavengers]=useState(false)
    ...
    const handleeditbuttonavengers=()=>{
        seteditmodeavengers(!editmodeavengers)
    }
...
return ( 
    <div className="reserveAvengers">
            ...
            {options  && 
                    <div className="optionsAvengers">
                            <h3>Want to change?</h3>
                            <button onClick={handleeditbuttonavengers}>Edit</button>
...
export default ReserveAvengers;