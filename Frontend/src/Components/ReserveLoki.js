...
const ReserveLoki = () => {
    ...
    const [reservation, setReservation]=useState({})
        ...
        const [editmodeloki, seteditmodeloki]=useState(false)
        ...
        const handleeditbuttonloki=()=>{
            seteditmodeloki(!editmodeloki)
        }
    ...
    return ( <div className="reserveLoki">
         <form onSubmit={handleSubmit}>
                ...
                {options  && 
                        <div className="optionsLoki">
                                <h3>Want to change?</h3>
                                <button onClick={handleeditbuttonloki}>Edit</button>
