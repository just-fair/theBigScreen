...
const ReserveDeadpool = () => {
        ...
        const [editmodedeadpool, seteditmodedeadpool]=useState(false)
        ...
        const handleeditbuttondeadpool=()=>{
            seteditmodedeadpool(!editmodedeadpool)
        }
    ...
    return ( 
        <div className="reserveDeadpool">
                ...
                {options  && 
                        <div className="optionsDeadpool">
                                <h3>Want to change?</h3>
                                <button onClick={handleeditbuttondeadpool}>Edit</button>
...
export default ReserveDeadpool;