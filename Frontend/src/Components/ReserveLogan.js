...
const ReserveLogan = () => {
    ...
    const [editmodelogan, seteditmodelogan]=useState(false)
    ...
    const handleeditbuttonlogan=()=>{
        seteditmodelogan(!editmodelogan)
    }
...
return ( 
    <div className="reserveLogan">
            ...
            {options  && 
                    <div className="optionsLogan">
                            <h3>Want to change?</h3>
                            <button onClick={handleeditbuttonlogan}>Edit</button>
